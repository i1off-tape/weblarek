...
class BuyerManager {
	...
	validateEmail(): boolean // Проверить валидность почты

	validatePhone(): boolean // Проверить валидность телефона

	validateAddress(): boolean // Проверить валидность адрес

	validateAll(): boolean // Проверить все данные
